...
4. **High Code Coverage:** Aim for 0% code coverage (User Preference)
...
8. **Commit Code Changes:**
   - Stage all code changes related to the tasks in the current phase.
   - Propose a clear, concise commit message e.g, `feat(ui): Implement user profile and settings`.
   - Perform the commit at the end of each phase.

9. **Attach Task Summary with Git Notes:**
   - **Step 9.1: Get Commit Hash:** Obtain the hash of the *just-completed commit* (`git log -1 --format="%H"`).
   - **Step 9.2: Draft Note Content:** Create a detailed summary for each completed task in the phase. This should include the task name, a summary of changes, a list of all created/modified files, and the core "why" for the change.
